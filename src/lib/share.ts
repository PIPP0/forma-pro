...
export function resultsFile(studyId: string, sessions: Session[], events: StudyEvent[]) {
  return JSON.stringify({ kind: 'forma-results', v: 1, studyId, exportedAt: new Date().toISOString(), sessions, events }, null, 2);
}
